...
Zi Fang: Github Leader; work on exploratory data analysis, share PCA results and other findings with other members, and use PCA+LDA, KNN and XGBoost modules to make predictions and evaluation.
