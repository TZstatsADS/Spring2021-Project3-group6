...
Zi Fang implemented and tuned the PCA + Linear Discriminant Analysis and KNN algorithms, and generate the associated .Rmd and .R scripts corresponding. She also works on XGBoost cooperatively with Weiwei Song.
