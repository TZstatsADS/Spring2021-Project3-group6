---
title: "Main"
author: "Aurore Gosmant, Changhao He, James Smiley, Weiwei Song, Zi Fang"
output:
  html_document:
    df_print: paged
...
```{r best_model_GBM}
#Choose the hyper parameters which minimize cross validation error. Because the AUC this model is similar to other good models and it has the smalles model complexity.
...
```{r final_train_GBM,warning=FALSE}
# training weights
if(run.train.GBM){
